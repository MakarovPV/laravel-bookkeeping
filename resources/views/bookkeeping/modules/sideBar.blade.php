	...
	<div id="mainchild">
		        ...
		        <div class="row main">
			        ...
			        <table class="table w-100 d-none mt-2 h3 border table-hover" data-tab="expenses">
			        	...
			        	<li class="d-none" id="li-form">
			        		<div class="row w-100 ml-0 pt-2 border-0 align-items-center">
			        			<form class="w-100 p-1" method="POST" action="">
			        				@csrf 
			        				<div class="form-row">
			        					<div class="col-8">
			        						<input type="text" class="form-control form-control-lg" name="source_name">
			        					</div>
			        					<div class="col-4">
			        						<input type="number" class="form-control form-control-lg" name="price">
			        					</div>
					          		<input type="submit" name="button" id="addNewSource" class="btn btn-primary mt-2 ml-1 w-100" value="Отправить" disabled>
					       		</form>
					        </div>	
			        	</li>
			        </table>
