...
Route::get('/build/income/', [App\Charts\IncomeChart::class, 'sendDataForChart'])->name('build.income');
Route::get('/build/expenses/', [App\Charts\ExpensesChart::class, 'sendDataForChart'])->name('build.expenses');
Route::get('/build/income_and_expenses', [App\Charts\IncomeExpensesCompareChart::class, 'sendDataForChart'])->name('build.income_and_expenses');
